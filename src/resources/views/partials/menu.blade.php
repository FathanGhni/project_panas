<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show" style="background-color: #3d007e; color: #ecf0f1; width: 250px; height: 100vh; position: fixed; top: 0; left: 0; transition: all 0.3s; z-index: 1000;">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('warga_access')
        <li class="c-sidebar-nav-item">
            <a href="{{ route("admin.wargas.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/wargas") || request()->is("admin/wargas/*") ? "c-active" : "" }}" style="color: #ecf0f1; transition: background-color 0.3s;" onmouseover="this.style.backgroundColor='#2a0a4b'" onmouseout="this.style.backgroundColor=''">
                <i class="fa-fw fas fa-users c-sidebar-nav-icon"></i>
                {{ trans('cruds.warga.title') }}
            </a>
        </li>
        @endcan
